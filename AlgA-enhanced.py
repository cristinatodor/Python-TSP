...
def geneticAlgorithm(num_cities, pop_size, elite_size, mutation_rate, generations):
...
tour_length, tour = geneticAlgorithm(num_cities, pop_size=100, elite_size=20, mutation_rate=0.01, generations=500)
